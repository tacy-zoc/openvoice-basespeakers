...
def get_bert(norm_text, word2ph, language, device):
    ...
    from .german_bert import get_bert_feature as de_bert
    from .russian_bert import get_bert_feature as ru_bert
    ...
    lang_bert_func_map = {"ZH": zh_bert, "EN": en_bert, "JP": jp_bert, 'ZH_MIX_EN': zh_mix_en_bert, 
                          'FR': fr_bert, 'SP': sp_bert, 'ES': sp_bert, 'DE': de_bert, "RU": ru_bert, "KR": kr_bert}
